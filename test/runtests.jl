...
splitat_test() = [1,2,3,4] |> F.splitat(2) |> F.equals(([1,2], [3,4]))

splitinto_test() = [1,2,3,4,5] |> F.splitinto(2) |> F.equals([[1,2],[3,4],[5]])

sum_test() = [1,2,3,4] |> F.sum |> F.equals(10)

sumby_test() = [1,2,3,4] |> F.sumby(x -> x + 1) |> F.equals(14)
